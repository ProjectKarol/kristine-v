...
if ( $available_gateways ) : ?>
	<form id="add_payment_method" method="post" class="nk-form-style-1">
		<div id="payment" class="woocommerce-Payment">
			...
			<div class="form-row">
				...
				<span class="nk-btn nk-btn-color-dark-1 khaki-relative">
					<?php esc_html_e( 'Add Payment Method', 'khaki' ); ?>
					<input type="submit" class="khaki-wc-submit" id="place_order" value="<?php esc_attr_e( 'Add Payment Method', 'khaki' ); ?>" />
				</span>
...
<div class="nk-info-box bg-main-5"><div class="nk-info-box-icon"><span class="ion-ios-alert"></span></div><?php esc_html_e( 'New payment methods can only be added during checkout. Please contact us if you require assistance.', 'khaki' ); ?></div>
