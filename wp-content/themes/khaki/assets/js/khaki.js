...
function bodySetScrollbar() {
    ...
    if (isBodyOverflowing) {
        $body.add($headerContent).add('.nk-navbar-full').css('paddingRight', scrollbarWidth + 'px');
        $('.nk-nav-toggler-right').css('marginRight', scrollbarWidth + 'px');
    }
}
...
function initLinkEffects() {
    ...
    if (this.options.navigationHoverEffect) {
        (0, _utility.$)('.nk-navbar:not(.nk-navbar-no-link-effect) ul > li > a:not(.btn):not(.nk-btn):not(.no-link-effect)').addClass('link-effect-' + this.options.navigationHoverEffect);
    }

    // Link Effect 1 (rotate all letters)
    (0, _utility.$)('.link-effect-1:not(.ready)').each(function () {
    ...
    _utility.$doc.on('mouseover', '.link-effect-1.ready', function () {
    ...
    (0, _utility.$)('.link-effect-2:not(.ready), .link-effect-3:not(.ready)').each(function () {
        (0, _utility.$)(this).addClass('ready');
    ...
    (0, _utility.$)('.link-effect-4:not(.ready)').each(function () {
        (0, _utility.$)(this).addClass('ready');
        (0, _utility.$)(this).html(function (i, letters) {
            return (0, _utility.$)('<span>').html(letters).prepend();
        });
    });
}
...
function initNavbar() {
    ...
    function openSubmenu($item) {
        if (!$item.hasClass('open')) {
            ...
            _utility.tween.set($item.children('.dropdown'), {
                y: -4
            });
            _utility.tween.to($item.children('.dropdown'), 0.3, {
                opacity: 1,
