...
?>
    <div class="<?php echo khaki_sanitize_class(khaki_get_theme_mod('search_boxed') ? 'container' : 'container-fluid'); ?>">
        <div class="nk-gap-4"></div>
        <?php if (khaki_get_theme_mod('search_show_title', true)): ?>
            <h1 class="nk-title"><?php printf(esc_html__('Search Results for "%s" Query', 'khaki'), get_search_query());?></h1>
        <?php endif; ?>
        <?php
        $pagination = khaki_get_theme_mod('search_pagination', true);
        $class = '';
        ...
        $style = khaki_get_theme_mod('search_list_style_content', true);
        $columns = khaki_get_theme_mod('search_list_columns_content', true);
        $simple_view = khaki_get_theme_mod('search_simple_view');
        $show_continue_button =  khaki_get_theme_mod('search_show_continue_button');
        $preview_description_type = khaki_get_theme_mod('search_preview_description_type_content', true);
        $preview_description_trim_cnt = khaki_get_theme_mod('search_preview_description_trim_cnt', 50, true);
