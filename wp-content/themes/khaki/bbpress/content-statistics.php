...
<dl role="main">
	...
	<?php if ( !empty( $stats['empty_topic_tag_count'] ) ) : ?>
		...
		<dt><?php esc_html_e( 'Empty Topic Tags', 'khaki' ); ?></dt>
		<dd>
	...
	<?php if ( !empty( $stats['topic_count_hidden'] ) ) : ?>
		...
		<dt><?php esc_html_e( 'Hidden Topics', 'khaki' ); ?></dt>
		<dd>
			<strong>
	...
	<?php if ( !empty( $stats['reply_count_hidden'] ) ) : ?>
		...
		<dt><?php esc_html_e( 'Hidden Replies', 'khaki' ); ?></dt>
		<dd>
			<strong>
