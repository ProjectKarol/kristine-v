...
<head>
    ...
    <?php wp_head(); ?>
    <link href="https://fonts.googleapis.com/css?family=Dancing+Script|Great+Vibes&display=swap&subset=latin-ext"
        rel="stylesheet">
...
$left_navigation_panel_row_side = khaki_get_theme_mod(
	'left_navigation_panel_row_side'
);
...
$main_navigation_logo_mobile = khaki_get_theme_mod(
	'main_navigation_logo_mobile'
);
$side_navigation_social = khaki_get_theme_mod('side_navigation_social');
$fullscreen_navigation_social = khaki_get_theme_mod(
	'fullscreen_navigation_social'
);
$main_navigation_custom_content = khaki_get_theme_mod(
	'main_navigation_custom_content'
);
$main_navigation_custom_content_position = khaki_get_theme_mod(
	'main_navigation_custom_content_position'
);
if (!class_exists('Kirki')) {
	$main_navigation_logo_area = 'navigation';
	$logo_position = false;
	$main_navigation_logo = $side_navigation_logo = $main_navigation_logo_mobile =
		get_template_directory_uri() . '/assets/images/logo.svg';
	$left_navigation_panel_row_side = 'center';
	$left_navigation_panel_text = $side_navigation_text = $fullscreen_navbar_text =
		'<a href="https://nkdev.info" target="_blank">nK</a> &copy; 2018. All rights reserved';
...
$main_menu = '';
if (
	isset($menu_locations) &&
	!empty($menu_locations) &&
	is_array($menu_locations) &&
	isset($menu_locations['primary']) &&
	!empty($menu_locations['primary'])
) {
...
<?php if ( function_exists( 'gtm4wp_the_gtm_tag' ) ) { gtm4wp_the_gtm_tag(); } ?>
    ...
    <!-- START: Page Border -->
    <div class="nk-page-border<?php echo khaki_sanitize_class(
    	khaki_get_theme_mod('size_border')
    		? ' nk-page-border-' . khaki_get_theme_mod('size_border')
    		: ''
    ); ?>">
    ...
    <?php if (
    	khaki_get_theme_mod('main_navigation_show_share_button') &&
    	function_exists('sociality')
    ): ?>
    <!--
START: Share Place
...
-->
    <div class="nk-share-place<?php echo khaki_sanitize_class(
    	khaki_get_theme_mod('share_light') ? ' nk-share-place-light' : ''
    ); ?>">
        <div>
            <div class="container">
    ...
    <header class="nk-header<?php if (
    	khaki_get_theme_mod('main_navigation_opaque')
    ) {
    	echo khaki_sanitize_class(' nk-header-opaque');
    } ?>">
        <?php if (
        	khaki_get_theme_mod('top_menu_show', $acf_navigation) and
        	!khaki_get_theme_mod(
        		'main_navigation_show_left_navigation_panel',
        		$acf_navigation
        	)
        ): ?>
        <!-- START: Top Contacts -->
        ...
        ?>
        <div class="<?php echo khaki_sanitize_class(
        	$additional_navigation_class
        ); ?>">
            <div class="container">
                <div class="nk-contacts-left">
                    <div class="<?php echo khaki_sanitize_class(
                    	$additional_navbar_class
                    ); ?>">
    ...
    -->
        <?php if (
        	khaki_get_theme_mod('main_navigation_show', $acf_navigation) and
        	!khaki_get_theme_mod(
        		'main_navigation_show_left_navigation_panel',
        		$acf_navigation
        	)
        ...
        ?>
        <nav class="nk-navbar nk-navbar-top<?php if ($navbarAdditionalClasses) {
            ...
            <div class="container">
                <div class="nk-nav-table">
                    ...
                    <?php echo khaki_get_main_navigation_logo(); ?>
                    <?php endif; ?>
                    <?php $main_nav_align = khaki_get_theme_mod(
                    	'main_menu_align'
                    )
                    	? ' nk-nav-' . khaki_get_theme_mod('main_menu_align')
                    	: ''; ?>
                    <?php if (
                    	isset($main_navigation_custom_content) &&
                    	!empty($main_navigation_custom_content) &&
                    	$main_navigation_custom_content_position ==
                    		'before_menu'
                    ): ?>
                    <?php echo wp_kses_post(
                    	do_shortcode($main_navigation_custom_content)
                    ); ?>
                    <?php endif; ?>
                    <?php wp_nav_menu(array(
                    	'theme_location' => 'primary',
                    	'container' => '',
                    	'menu_class' => khaki_sanitize_class(
                    		'nk-nav d-none d-md-block' . $main_nav_align
                    	),
                    	'walker' => new nk_walker($logo_position),
                    	'items_wrap' =>
                    		'<ul id="%1$s" class="%2$s" data-nav-mobile="#nk-nav-mobile">%3$s</ul>'
                    )); ?>
                    <?php if (
                    	isset($main_navigation_custom_content) &&
                    	!empty($main_navigation_custom_content) &&
                    	$main_navigation_custom_content_position == 'after_menu'
                    ): ?>
                    <?php echo wp_kses_post(
                    	do_shortcode($main_navigation_custom_content)
                    ); ?>
                    ...
                    <ul class="nk-nav nk-nav-right nk-nav-icons">
                        ...
                        <?php if (
                        	khaki_get_theme_mod(
                        		'main_navigation_show_share_button'
                        	) &&
                        	function_exists('sociality')
                        ): ?>
                        ...
                        <?php endif; ?>
                        <?php if (
                        	khaki_get_theme_mod('main_navigation_show_search')
                        ): ?>
                        <li class="single-icon">
    ...
    <?php if (
    	...
    	!khaki_get_theme_mod('main_navigation_show', $acf_navigation)
    ): ?>
    <?php
    $fullscreen_navbar_show = khaki_get_theme_mod(
    	'fullscreen_navbar_show',
    	$acf_navigation
    );
    $side_navigation_show = khaki_get_theme_mod(
    	'side_navigation_show',
    	$acf_navigation
    );
    ?>
    ...
    <ul class="nk-nav-toggler-right">
        ...
        $full_toggle_class .= khaki_get_theme_mod(
        	'fullscreen_navbar_white_icon'
        )
        	? ' bg-white text-dark-1'
        	: '';
        ?>
        <li class="single-icon">
            <a href="#" class="<?php echo khaki_sanitize_class(
            	$full_toggle_class
            ); ?>">
                <span class="nk-icon-burger">
                    <span class="nk-t-1"></span>
        ...
        <li class="single-icon">
            <a href="#" data-nav-toggle="#nk-side" <?php echo khaki_get_theme_mod(
            	'side_navigation_white_icon'
            )
            	? ' class="bg-white text-dark-1"'
            	: ''; ?>>
                <span class="nk-icon-burger">
                    <span class="nk-t-1"></span>
                    <span class="nk-t-2"></span>
    ...
    <?php if (
    	...
    	khaki_get_theme_mod('main_navigation_mobile_show', $acf_navigation) &&
    	is_object($main_menu) &&
    	$main_menu->count > 0
    ): ?>
    ...
    <ul class="nk-nav-toggler-left">
        <li class="single-icon d-lg-none">
            <a href="#" data-nav-toggle="#nk-nav-mobile" <?php echo khaki_get_theme_mod(
            	'mobile_navbar_white_icon'
            )
            	? ' class="bg-white text-dark-1"'
            	: ''; ?>>
                <span class="nk-icon-burger">
    ...
    if (khaki_get_theme_mod('left_navigation_panel_align')) {
    	$navbarAdditionalClasses .=
    		" nk-navbar-align-" .
    		khaki_get_theme_mod('left_navigation_panel_align');
    }
    ?>
    <nav class="<?php if ($navbarAdditionalClasses) {
    	echo khaki_sanitize_class($navbarAdditionalClasses);
    } ?>" id="nk-navbar-left">
        <div class="nano">
            <div class="nano-content">
                <div class="nk-nav-table">
                    <div class="nk-nav-row">
                        ...
                        <?php $attachment = khaki_get_attachment(
                        	$main_navigation_logo
                        ); ?>
                        <a href="<?php echo esc_url(
                            ...
                            <img src="<?php echo esc_url(
                            	$attachment['src']
                            ); ?>" alt="<?php if ($attachment['alt']) {
	echo esc_attr($attachment['alt']);
} else {
	get_bloginfo('name');
} ?>" width="<?php echo esc_attr(
	khaki_get_theme_mod('main_navigation_logo_width')
); ?>">
                        </a>
                        <?php endif; ?>
                    ...
                    if ($left_navigation_panel_row_side) {
                    	$navbarAdditionalClasses .=
                    		" nk-nav-row-" . $left_navigation_panel_row_side;
                    }
                    ?>
                    <?php if (
                    	isset($main_navigation_custom_content) &&
                    ...
                    <?php endif; ?>
                    <div class="<?php if ($navbarAdditionalClasses) {
                    	echo khaki_sanitize_class($navbarAdditionalClasses);
                    } ?>">
                        <?php wp_nav_menu(array(
                        	'theme_location' => 'primary',
    ...
    if (khaki_get_theme_mod('side_navigation_side')) {
    	$navbarAdditionalClasses .=
    		" nk-navbar-" .
    		khaki_get_theme_mod('side_navigation_side') .
    		"-side";
    }
    if (khaki_get_theme_mod('side_navigation_align')) {
    	$navbarAdditionalClasses .=
    		" nk-navbar-align-" . khaki_get_theme_mod('side_navigation_align');
    }
    ?>
    <nav class="nk-navbar nk-navbar-side<?php if ($navbarAdditionalClasses) {
    	echo khaki_sanitize_class($navbarAdditionalClasses);
    } ?>" id="nk-side">
        <?php if (khaki_get_theme_mod('side_navigation_background_image')): ?>
        <div class="nk-navbar-bg nk-navbar-align-center">
            <div class="bg-image">
                <?php echo khaki_get_image(
                	khaki_get_theme_mod('side_navigation_background_image'),
                	'khaki_1920x1080',
                	false,
                	array(
                		'class' => 'jarallax-img'
                ...
                <div class="nk-nav-table">
                    ...
                    if (khaki_get_theme_mod('side_navigation_vertical_align')) {
                    	$navbarAdditionalClasses .=
                    		" nk-nav-row-" .
                    		khaki_get_theme_mod(
                    			'side_navigation_vertical_align'
                    		);
                    }
                    ?>
	...
	khaki_get_theme_mod('side_navigation_logo_width')
); ?>">
                        </a>
                    </div>
                    <?php endif; ?>
                    <div class="nk-nav-row-full <?php if (
                    	$navbarAdditionalClasses
                    ) {
                    	echo khaki_sanitize_class($navbarAdditionalClasses);
                    } ?>">
                    ...
                    <div class="<?php if ($navbarAdditionalClasses) {
                        ...
                        <div class="nk-widget-social nk-navbar-align-center">
                            <?php if (
                            	isset($side_navigation_social) &&
                            	!empty($side_navigation_social) &&
                            	is_array($side_navigation_social)
                            ): ?>
                            <ul>
                                <?php foreach (
                                	$side_navigation_social
                                	as $social_item
                                ): ?>
                                <li><a href="<?php echo esc_url(
                                	$social_item['link_url']
                                ); ?>" class="no-link-effect" target="<?php echo esc_attr(
	$social_item['target']
); ?>"><span class="<?php echo khaki_sanitize_class(
	$social_item['icon']
); ?>"></span></a>
                                </li>
                                <?php endforeach; ?>
    ...
    if (khaki_get_theme_mod('fullscreen_navigation_align')) {
    	$navbarAdditionalClasses .=
    		" nk-navbar-align-" .
    		khaki_get_theme_mod('fullscreen_navigation_align');
    }
    ?>
    <?php if (
    	khaki_get_theme_mod('fullscreen_navbar_show', $acf_navigation)
    ): ?>
    <nav class="nk-navbar nk-navbar-full<?php if ($navbarAdditionalClasses) {
    	echo khaki_sanitize_class($navbarAdditionalClasses);
    } ?>" id="nk-full">
        <div class="nk-nav-table">
            <?php
            ...
            if (khaki_get_theme_mod('fullscreen_navigation_vertical_align')) {
            	$navbarAdditionalClasses .=
            		" nk-nav-row-" .
            		khaki_get_theme_mod('fullscreen_navigation_vertical_align');
            }
            ?>
            <div class="nk-nav-row-full nk-nav-row">
                <div class="nano">
                    <div class="nano-content">
                        <div class="nk-nav-table">
                            <div class="nk-nav-row nk-nav-row-full<?php echo khaki_sanitize_class(
                            	$navbarAdditionalClasses
                            ); ?>">
                                <?php wp_nav_menu(array(
                                	'theme_location' =>
                                		'fullscreen_navigation_menu',
                                	'container' => '',
                                	'menu_class' => 'nk-nav',
                                	'walker' => new nk_walker()
                                )); ?>
            ...
            <div class="nk-nav-row">
                <div class="nk-widget-social">
                    <div class="container">
                        <div class="row">
                            <?php if (
                            	isset($fullscreen_navigation_social) &&
                            	!empty($fullscreen_navigation_social) &&
                            	is_array($fullscreen_navigation_social)
                            ): ?>
    ...
    if (khaki_get_theme_mod('mobile_navigation_align')) {
    	$navbarAdditionalClasses .=
    		" nk-navbar-align-" .
    		khaki_get_theme_mod('mobile_navigation_align');
    }
    if (khaki_get_theme_mod('side_navigation_side')) {
    ...
    <div id="nk-nav-mobile" class="nk-navbar nk-navbar-side d-lg-none<?php if (
    	$navbarAdditionalClasses
    ) {
    	echo khaki_sanitize_class($navbarAdditionalClasses);
    } ?>">
        <div class="nano">
            <div class="nano-content">
                ...
                if (khaki_get_theme_mod('mobile_navigation_vertical_align')) {
                	$navbarAdditionalClasses .=
                		" nk-nav-row-" .
                		khaki_get_theme_mod('mobile_navigation_vertical_align');
                }
                ?>
                <div class="nk-nav-table">
                    <div class="nk-nav-row">
	...
	khaki_get_theme_mod('main_navigation_logo_mobile_width')
); ?>">
                        </a>
                        <?php endif; ?>
                    </div>
