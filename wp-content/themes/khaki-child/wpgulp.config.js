...
module.exports = {
	...
	// Project options.
	projectURL: 'https://www.kristine-v.loc', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	productURL: './', // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.
	browserAutoOpen: true,
	injectChanges: true,

	// Style options.
	styleSRC: './assets/css/style-main.scss', // Path to main .scss file.
	styleDestination: './disc/css', // Path to place the compiled CSS file. Default set to root folder.
	...
	jsCustomDestination: './disc/js', // Path to place the compiled JS custom scripts file.
