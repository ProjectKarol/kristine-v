...
All WooCommerce variable products have a dropdown to select which variant the customer wants to add to cart. The standard behavior is to not set a default and until a variant is chosen the 'Add to Cart' button is not visible.
