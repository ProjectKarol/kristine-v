jQuery(function ($) {
    ...
    $("#_swatch_type").on('change', function () {
        if ($(this).val() == 'pickers') {
            $('#_swatch_type_options').show();
        } else {
            $('#_swatch_type_options').hide();
    ...
    $('#swatches a.wcsap_edit_field').on('click', function (event) {
    ...
    $('.wcsap_field_meta').on('click', function (event) {
        event.preventDefault();
    ...
    $('select._swatch_type_options_attribute_type').change(function () {
        ...
        var $preview = $(this).closest('div.sub_field').find('.nkwcs-color-image-item');
    ...
    $('.remove_swatch_image_button').click(function (e) {
        ...
        $(this).closest('.sub_field').find('img').attr('src', nkwcs_params.placeholder_img_src);
    });
