<?php
/**
 * Radio toggler buttons variation
 */
echo '<ul id="radio_toggler_select_' . esc_attr( $id ) . '" class="nkwcs-radio-toggler" data-attribute_name="attribute_' . esc_attr( sanitize_title( $attribute ) ) . '">';
