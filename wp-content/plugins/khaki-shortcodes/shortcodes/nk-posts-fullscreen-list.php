    ...
    function nk_posts_fullscreen_list($atts, $content = null)
    {
        ...
        while ($posts_query->have_posts()) : $posts_query->the_post();
            ...
            if(isset($post_url) && !empty($post_url)) {
                ...
                $result .= '<span>'.esc_html__('More Info', 'khaki-shortcodes').'</span>';
                $result .= '<span class="icon"><i class="ion-ios-arrow-right"></i></span>';
                $result .= '</a>';
                $result .= '</div>';
            }
            $result .= '</div>';
...
if (!function_exists('vc_nk_posts_fullscreen_list')) :
    function vc_nk_posts_fullscreen_list()
    {
        ...
        if (function_exists('vc_map')) {
            ...
            vc_map(array(
                'name' => esc_html__('nK Posts Fullscreen List', 'khaki-shortcodes'),
