...
if ( ! function_exists( 'vc_nk_twitter' ) ) :
    function vc_nk_twitter() {
        if(function_exists('vc_map')) {
            ...
            vc_map( array(
                'name' => esc_html__('nK Twitter', 'khaki-shortcodes'),
                'base' => 'nk_twitter',
                'controls' => 'full',
                'category' => 'nK',
                ...
                'params' => array_merge(array(
                    array(
                        ...
                        'description' => esc_html__("Before use, you need to configure access to Twitter here - ", 'khaki-shortcodes') . '<a target="_blank" href="' . esc_url(admin_url('customize.php?autofocus[section]=khaki_twitter')) . '">' . esc_html(admin_url('customize.php?autofocus[section]=khaki_twitter')) . '</a>',
                    ),
                    array(
                        'type'        => 'textfield',
