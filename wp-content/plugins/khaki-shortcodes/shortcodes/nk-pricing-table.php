...
if (!function_exists('vc_nk_pricing_table')) :
    function vc_nk_pricing_table()
    {
        if (function_exists('vc_map')) {
            ...
            vc_map(array(
                'name' => esc_html__('nK Pricing Table', 'khaki-shortcodes'),
                ...
                'params' => array_merge(array(
                    ...
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Price', 'khaki-shortcodes'),
                        'param_name' => 'price',
                        'value' => '',
                        'description' => '',
                        'dependency' => array(
                    ...
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Start From', 'khaki-shortcodes'),
                        'param_name' => 'start_from',
                        'value' => '',
                        "std" => 0,
                        'description' => esc_html__('Price of accumulation effect', 'khaki-shortcodes'),
                        'dependency' => array(
                            'element' => 'style',
                            'value' => array(
                                '1',
                    ...
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Currency Symbol', 'khaki-shortcodes'),
                    ...
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Period', 'khaki-shortcodes'),
                        'param_name' => 'period',
                        'value' => '',
                        'description' => '',
                        'dependency' => array(
                    ...
                    array(
                        'type' => 'param_group',
                        'heading' => esc_html__('Features List', 'khaki-shortcodes'),
                        'value' => '',
                        'param_name' => 'features_list',
                        'params' => array(
                            array(
                                'type' => 'textfield',
                                'heading' => esc_html__('Feature', 'khaki-shortcodes'),
                                'param_name' => 'feature',
                                'admin_label' => true,
                            ),
                        ),
                    ...
                    array(
                        'type' => 'param_group',
                        'heading' => esc_html__('Price List', 'khaki-shortcodes'),
                        'value' => '',
                        'param_name' => 'price_list',
                        'params' => array(
                            array(
                                'type' => 'textfield',
                                'heading' => esc_html__('Service or Product Title', 'khaki-shortcodes'),
                                'param_name' => 'name',
                                'admin_label' => true,
                            ),
                            array(
                            ...
                            array(
                                'type' => 'textfield',
                                'heading' => esc_html__('Description', 'khaki-shortcodes'),
                    ...
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Button Title', 'khaki-shortcodes'),
                    ...
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Button Link', 'khaki-shortcodes'),
                    ...
                    array(
                        'type'       => 'dropdown',
                        'heading'    => esc_html__('Substrate Background Color', 'khaki-shortcodes'),
                    ...
                    array(
                        'type' => 'colorpicker',
                        'heading' => esc_html__('Header Color', 'khaki-shortcodes'),
                    ...
                    array(
                        'type'       => 'attach_image',
                        'heading'    => esc_html__('Header Background Image', 'khaki-shortcodes'),
