...
if ( ! function_exists( 'vc_nk_countdown' ) ) :
    function vc_nk_countdown() {
        if(function_exists('vc_map')) {
            ...
            vc_map( array(
                'name' => esc_html__('nK Countdown', 'khaki-shortcodes'),
                'base' => 'nk_countdown',
                'controls' => 'full',
                'category' => 'nK',
                ...
                'params' => array_merge(array(
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__("Date End", 'khaki-shortcodes'),
                        'param_name'  => 'date_end',
                        'value'       => '2017-11-26 08:20',
                        'description' => esc_html__("Example: 2017-11-26 08:20", 'khaki-shortcodes'),
                        'admin_label' => true,
                    ),
                    array(
                        'type'       => 'dropdown',
                        'heading'    => esc_html__('Date Timezone', 'khaki-shortcodes'),
