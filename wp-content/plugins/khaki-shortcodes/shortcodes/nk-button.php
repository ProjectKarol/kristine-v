...
if (!function_exists('nk_button')) :
    function nk_button($atts, $content = null)
    {
        ...
        if (khaki_nk_check($icon_right)) {
            $icon_str_right = ' <span class="icon"><i class="' . khaki_sanitize_class($icon_right) . '"></i></span> ';
        }
...
if ( ! function_exists( 'vc_nk_button' ) ) :
    function vc_nk_button() {
        if(function_exists('vc_map')) {
            ...
            vc_map( array(
                'name' => esc_html__('nK Button', 'khaki-shortcodes'),
                'base' => 'nk_button',
                'controls' => 'full',
                'category' => 'nK',
                ...
                'params' => array_merge(array(
                    ...
                    array(
                        "type"        => "iconpicker",
                        "heading"     => esc_html__('Icon Right', 'khaki-shortcodes'),
                        "param_name"  => "icon_right"
                    ),
                    array(
                        "type"        => "iconpicker",
                        "heading"     => esc_html__('Icon Left', 'khaki-shortcodes'),
                    ...
                    array(
                        ...
                        'value'      => array(
                            ...
                            esc_html__('Icon From Top no title', 'khaki-shortcodes')  => '1-top',
                            esc_html__('Icon From Bottom no title', 'khaki-shortcodes')  => '1-bottom',
                            esc_html__('Icon from left no title', 'khaki-shortcodes')  => '1-left',
                            esc_html__('Icon from Right no title', 'khaki-shortcodes')  => '1-right',
                            esc_html__('Icon From Left', 'khaki-shortcodes') => '2-left',
                            esc_html__('Icon From Right', 'khaki-shortcodes')  => '2-right',
                            esc_html__('Glow From Left', 'khaki-shortcodes') => '5-left',
                            esc_html__('Glow From Right', 'khaki-shortcodes') => '5-right',
                            esc_html__('Fill From Left Angle', 'khaki-shortcodes') => '3-left',
                            esc_html__('Fill From Right Angle', 'khaki-shortcodes')  => '3-right',
                            esc_html__('Fill From Top', 'khaki-shortcodes')  => '4-top',
                            esc_html__('Fill From Bottom', 'khaki-shortcodes')  => '4-bottom',
                            esc_html__('Fill From Left', 'khaki-shortcodes') => '4-left',
                            esc_html__('Fill From Right', 'khaki-shortcodes') => '4-right',
                            esc_html__('Fill From Center Vertical', 'khaki-shortcodes') => '6-v',
                            esc_html__('Fill From Center Horizontal', 'khaki-shortcodes') =>'6-h',
                            esc_html__('Fill From Center Vertical 2 ', 'khaki-shortcodes') => '7-v',
                            esc_html__('Fill From Center Horizontal 2', 'khaki-shortcodes') =>'7-h'
                        ),
                        'description' => ''
                    ),
                    array(
                        'type'       => 'dropdown',
                        'heading'    => esc_html__('Fill Color', 'khaki-shortcodes'),
                    ...
                    array(
                        ...
                        'value'      => array(
                            ...
                            esc_html__('X2', 'khaki-shortcodes')     => 'x2',
                            esc_html__('X3', 'khaki-shortcodes')     => 'x3',
                            esc_html__('X4', 'khaki-shortcodes')     => 'x4'
                        ),
                        'description' => ''
                    ),
                    array(
                        'param_name'  => 'block',
                        'heading'     => esc_html__('Block', 'khaki-shortcodes'),
                        'type'        => 'checkbox',
                        'value'       => array( '' => true ),
                    ),
                    array(
                        'param_name'  => 'outline',
                        'heading'     => esc_html__('Outline', 'khaki-shortcodes'),
                        'type'        => 'checkbox',
                        'value'       => array( '' => true ),
                    ),
                    array(
                        'param_name'  => 'three_dimensional',
                        'heading'     => esc_html__('3D Effect', 'khaki-shortcodes'),
                        'type'        => 'checkbox',
                        'value'       => array( '' => true ),
                    ),
                    array(
                        'param_name'  => 'circle_hover',
                        'heading'     => esc_html__('Circle Hover', 'khaki-shortcodes'),
                        'type'        => 'checkbox',
                        'value'       => array( '' => true ),
                    ),
                    array(
                        'param_name'  => 'hover',
                        'heading'     => esc_html__('Always Hover', 'khaki-shortcodes'),
                        'type'        => 'checkbox',
                        'value'       => array( '' => true ),
                    ),
                    array(
                        'type'       => 'dropdown',
                        'heading'    => esc_html__('The Edges', 'khaki-shortcodes'),
                        'param_name' => 'edges',
                        'std'        => false,
                        'value'      => array(
                            esc_html__('Disabled', 'khaki-shortcodes')  => false,
                            esc_html__('Circle', 'khaki-shortcodes')  => 'circle',
                            esc_html__('Rounded', 'khaki-shortcodes')  => 'rounded',
                        ),
                        'description' => ''
                    ),
                    array(
                    ...
                    array(
                        'type'       => 'dropdown',
                        'heading'    => esc_html__('Background Hover Color', 'khaki-shortcodes'),
