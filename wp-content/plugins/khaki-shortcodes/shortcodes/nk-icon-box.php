...
if (!function_exists('vc_nk_icon_box')) :
    function vc_nk_icon_box()
    {
        if (function_exists('vc_map')) {
            ...
            vc_map(array(
                'name' => esc_html__('nK Icon Box', 'khaki-shortcodes'),
                'base' => 'nk_icon_box',
                'controls' => 'full',
                'category' => 'nK',
                ...
                'params' => array_merge(array(
                    ...
                    array(
                        'type' => 'checkbox',
                        'heading' => esc_html__('Hover', 'khaki-shortcodes'),
                        'param_name' => 'hover',
                        'value' => array('' => true)
                    ),
                    array(
                        'type' => 'checkbox',
                        'heading' => esc_html__('Inverted', 'khaki-shortcodes'),
                        'param_name' => 'inverted',
                        'value' => array('' => true)
                    ),
                    array(
                    ...
                    array(
                        'type' => 'dropdown',
                        'heading' => esc_html__('Hover Color', 'khaki-shortcodes'),
                    ...
                    array(
                        'type' => 'dropdown',
                        'heading' => esc_html__('Hover Color Background', 'khaki-shortcodes'),
                    ...
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('URL', 'khaki-shortcodes'),
                        'param_name' => 'link',
                        'value' => '',
                        'description' => '',
                        'admin_label' => true,
