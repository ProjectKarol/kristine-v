...
if (!function_exists('nk_video_icon')) :
    function nk_video_icon($atts, $content = null)
    {
        ...
        $result .= '<a class="'.khaki_sanitize_class($class).'" href="'.esc_url($link).'"><span class="'.khaki_sanitize_class($style_video_icon).'"><i class="fa fa-play pl-5"></i></span></a>';
...
if ( ! function_exists( 'vc_nk_video_icon' ) ) :
    function vc_nk_video_icon() {
        if(function_exists('vc_map')) {
            ...
            vc_map( array(
                'name' => esc_html__('nK Video Icon', 'khaki-shortcodes'),
                'base' => 'nk_video_icon',
                'controls' => 'full',
                'category' => 'nK',
                'icon'     => 'icon-nk',
                'params' => array_merge(array(
                    ...
                    array(
                        ...
                        'std'        => false,
                        'value'      => array(
                            esc_html__('Black', 'khaki-shortcodes')  => false,
                            esc_html__('Black 2', 'khaki-shortcodes')  => '2',
                            esc_html__('Light', 'khaki-shortcodes')  => 'light',
                            esc_html__('Light 2', 'khaki-shortcodes')  => '2-light',
                        ),
                        'description' => ''
                    ),
                    array(
