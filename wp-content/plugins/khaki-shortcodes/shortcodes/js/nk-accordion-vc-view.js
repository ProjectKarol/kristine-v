...
!function( $ ) {
  ...
  window.nKAccordionView = vc.shortcode_view.extend( {
    ...
    render: function () {
      window.nKAccordionView.__super__.render.call( this );
    ...
    changeShortcodeParams: function ( model ) {
      ...
      window.nKAccordionView.__super__.changeShortcodeParams.call( this, model );
    ...
    addTab: function ( e ) {
      ...
      vc.shortcodes.create( {
        shortcode: 'nk_accordion_tab',
        params: { title: window.i18nLocale.section },
        parent_id: this.model.id
      } );
    },
    _loadDefaults: function () {
      window.nKAccordionView.__super__._loadDefaults.call( this );
    }
  } );

  window.nKAccordionTabView = window.VcColumnView.extend( {
    events: {
    ...
    changeShortcodeParams: function ( model ) {
      ...
      window.nKAccordionTabView.__super__.changeShortcodeParams.call( this, model );
      params = model.get( 'params' );
