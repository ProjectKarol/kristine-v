...
class NK_Social_Links extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            esc_html__('(nK) Social Links', 'khaki-widgets'), // Name
    ...
    public function widget($args, $instance)
    {
        ...
        if (function_exists('acf_add_local_field_group')):
            ...
            if($social_style == 'style_1'){
                $social_style_class = 'nk-footer-social';
            }elseif($social_style == 'style_2'){
                $social_style_class = 'nk-footer-social-2';
            }
...
add_action('widgets_init',
    create_function('', 'return register_widget("NK_Social_Links");')
);
                ...
                'sub_fields' => array (
                    array (
                        ...
                        'choices' => array (
                            ...
                            'ion-social-instagram-outline' => 'Instagram',
                            ...
                            'ion-social-dribbble-outline' => 'Dribbble',
