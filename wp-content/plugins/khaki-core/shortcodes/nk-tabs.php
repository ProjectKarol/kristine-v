...
if ( ! function_exists( 'vc_nk_tabs' ) ) :
    function vc_nk_tabs() {
        if(function_exists("vc_map")) {
            ...
            vc_map( array(
                "name"                    => esc_html__("nK Tabs", 'khaki-core'),
                "base"                    => "nk_tabs",
                "category"                => "nK",
                "icon"                    => "icon-nk icon-nk-tabs",
                "show_settings_on_create" => false,
                "is_container"            => true,
                "admin_enqueue_js"        => khaki_core()->plugin_url . "shortcodes/js/nk-tabs-vc-view.js",
                "admin_enqueue_css"       => khaki_core()->plugin_url . "shortcodes/css/nk-tabs-vc-view.css",
                ...
                "default_content" => "
                    [nk_tab title='" . esc_html__( 'Tab 1', 'khaki-core' ) . "' active='true'][/nk_tab]
                    [nk_tab title='" . esc_html__( 'Tab 2', 'khaki-core' ) . "'][/nk_tab]",
                "js_view" => "nKTabsView"
            ) );
        }
    }
...
if ( ! function_exists( 'vc_nk_single_tab' ) ) :
    function vc_nk_single_tab() {
        if(function_exists("vc_map")) {
            /* Register shortcode with Visual Composer */
            vc_map( array(
                "name"             => esc_html__("nK Single Tab", 'khaki-core'),
                "base"             => "nk_tab",
                "category"         => "nK",
                "icon"             => "icon-nk icon-nk-tabs",
