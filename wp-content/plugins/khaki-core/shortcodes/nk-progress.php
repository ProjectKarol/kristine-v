...
if ( ! function_exists( 'vc_nk_progress' ) ) :
    function vc_nk_progress() {
        if(function_exists('vc_map')) {
            ...
            vc_map( array(
                'name' => esc_html__('nK Progress', 'khaki-core'),
                'base' => 'nk_progress',
                'controls' => 'full',
                'category' => 'nK',
                ...
                'params' => array_merge(array(
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Value', 'khaki-core'),
                        'param_name'  => 'value',
                        'value'       => '25',
                        'description' => '',
                        'admin_label' => true
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Show Mask', 'khaki-core'),
                        'description' => esc_html__('Use mask to change progress value view. Add {$} to show current progress value.', 'khaki-core'),
                        'param_name'  => 'mask',
                        'value'       => '{$}%',
                    ),
                    array(
                        ...
                        'value'      => array(
                            ...
                            esc_html__('Extra Large', 'khaki-core')  => 'xlg',
                        ),
                        'description' => ''
                    ),
                    array(
                        'type'        => 'checkbox',
                        'heading'     => esc_html__('Show Value', 'khaki-core'),
                    ...
                    array(
                        'type'        => 'checkbox',
                        'heading'     => esc_html__('Value on Right Side', 'khaki-core'),
                        'param_name'  => 'value_on_right_side',
                        'value'       => array( '' => true )
                    ),
                    array(
                        'type'        => 'checkbox',
                        'heading'     => esc_html__('Animate on Show', 'khaki-core'),
                    ...
                    array(
                        'type'       => 'colorpicker',
                        'heading'    => esc_html__('Background Bar Color', 'khaki-core'),
