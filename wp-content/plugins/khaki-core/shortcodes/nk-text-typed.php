...
if ( ! function_exists( 'vc_nk_text_typed' ) ) :
    function vc_nk_text_typed() {
        if(function_exists('vc_map')) {
            ...
            vc_map( array(
                'name' => esc_html__('nK Text Typed', 'khaki-core'),
                'base' => 'nk_text_typed',
                'controls' => 'full',
                'category' => 'nK',
                ...
                'params' => array_merge(array(
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Container Classes', 'khaki-core'),
                        'param_name'  => 'classes',
                        'value'       => '',
                        'description' => '',
                    ),
                    array(
                        'type'        => 'param_group',
                        'heading'     => esc_html__('Typed Text Variants', 'khaki-core'),
                        'value'       => '',
                        'param_name'  => 'content',
                        'params'      => array(
                            array(
                            ...
                            array(
                                'type'        => 'textfield',
                                'heading'     => esc_html__('Custom Speed', 'khaki-core'),
                                'param_name'  => 'custom_speed',
                                'value'       => '',
                                'description' => esc_html__("Speed in milliseconds, example: 3000", 'khaki-core'),
                            )
                        ),
                    ),
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Text Before', 'khaki-core'),
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Text After', 'khaki-core'),
                    ...
                    array(
                        'type'        => 'checkbox',
                        'heading'     => esc_html__('Loop', 'khaki-core'),
                        'group'       => esc_html__( 'Advanced', 'khaki-core'),
                        'param_name'  => 'loop',
                        'value'       => array( '' => true )
                    ),
                    array(
                        'type'        => 'checkbox',
                        'heading'     => esc_html__('Shuffle', 'khaki-core'),
                        'group'       => esc_html__( 'Advanced', 'khaki-core'),
                        'param_name'  => 'shuffle',
                        'value'       => array( '' => true )
                    ),
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Cursor', 'khaki-core'),
                        'group'       => esc_html__( 'Advanced', 'khaki-core'),
                        'param_name'  => 'cursor',
                        'value'       => '_',
                        'description' => '',
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Type Speed', 'khaki-core'),
                        'group'       => esc_html__( 'Advanced', 'khaki-core'),
                        'param_name'  => 'type_speed',
                        'value'       => '90',
                        'description' => esc_html__("Speed in milliseconds, example: 90", 'khaki-core'),
                    ),
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Start Delay', 'khaki-core'),
                        'group'       => esc_html__( 'Advanced', 'khaki-core'),
                        'param_name'  => 'start_delay',
                        'value'       => '0',
                        'description' => esc_html__("Delay in milliseconds, example: 0", 'khaki-core'),
                    ),
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Back Speed', 'khaki-core'),
                        'group'       => esc_html__( 'Advanced', 'khaki-core'),
                        'param_name'  => 'back_speed',
                        'value'       => '60',
                        'description' => esc_html__("Speed in milliseconds, example: 60", 'khaki-core'),
                    ),
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Back Delay', 'khaki-core'),
                        'group'       => esc_html__( 'Advanced', 'khaki-core'),
                        'param_name'  => 'back_delay',
                        'value'       => '1000',
                        'description' => esc_html__("Speed in milliseconds, example: 1000", 'khaki-core'),
                    ),
                ), khaki_get_css_tab())
            ) );
        }
