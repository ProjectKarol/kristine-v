...
if ( ! function_exists( 'vc_nk_accordion' ) ) :
    function vc_nk_accordion() {
        if(function_exists("vc_map")) {
            ...
            vc_map( array(
                'name'               => esc_html__('nK Accordion', 'khaki-core'),
                'base'               => 'nk_accordion',
                'show_settings_on_create' => false,
                'is_container'       => true,
                'category'           => 'nK',
                'icon'               => 'icon-nk icon-nk-accordion',
                'admin_enqueue_css'  => khaki_core()->plugin_url . 'shortcodes/css/nk-accordion-vc-view.css',
                'admin_enqueue_js'   => khaki_core()->plugin_url . 'shortcodes/js/nk-accordion-vc-view.js',
                ...
                'custom_markup' => "
                    ...
                    <div class='tab_controls'>
                        <a class='add_tab' title='" . esc_html__( "Add section", 'khaki-core' ) . "'><span class='vc_icon'></span> <span class='tab-label'>" . esc_html__( "Add section", 'khaki-core' ) . "</span></a>
                    </div>",
                'default_content' => "
                    [nk_accordion_tab title='" . esc_html__( "Section 1", 'khaki-core' ) . "'][/nk_accordion_tab]
                    [nk_accordion_tab title='" . esc_html__( "Section 2", 'khaki-core' ) . "'][/nk_accordion_tab]
                ",
...
if ( ! function_exists( 'vc_nk_accordion_tab' ) ) :
    function vc_nk_accordion_tab() {
        if(function_exists("vc_map")) {
            /* Register shortcode with Visual Composer */
            vc_map( array(
                'name'             => esc_html__('nK Accordion Content', 'khaki-core'),
                ...
                'params'           => array_merge(array(
                    ...
                    array(
                        'type'       => 'checkbox',
                        'heading'    => esc_html__( 'Active', 'khaki-core' ),
                        'param_name' => 'active',
                        'value'      => array( '' => true )
                    ),
                ), khaki_get_css_tab()),
