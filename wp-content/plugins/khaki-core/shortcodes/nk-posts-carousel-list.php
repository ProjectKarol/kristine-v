...
if (!function_exists('vc_nk_posts_carousel_list')) :
    function vc_nk_posts_carousel_list()
    {
        ...
        if (function_exists('vc_map')) {
            ...
            vc_map(array(
                'name' => esc_html__('nK Posts Carousel List', 'khaki-core'),
                ...
                'params' => array_merge(array(
                    ...
                    array(
                        'type'       => 'dropdown',
                        'heading'    => esc_html__('Photo Size', 'khaki-core'),
                    ...
                    array(
                        "type" => "textfield",
                        "heading" => esc_html__("Data Size", 'khaki-core'),
                    ...
                    array(
                        ...
                        'heading'     => esc_html__('Show Navigation', 'khaki-core'),
                        'type'        => 'checkbox',
                        'value'       => array( '' => true ),
                    ),
                    array(
                        "type" => "dropdown",
                        "heading" => esc_html__("Navigate Position", 'khaki-core'),
                        "param_name" => "navigate_position",
                        "value" => array(
                            esc_html__("Before Carousel", 'khaki-core') => 'before',
                            esc_html__("After Carousel", 'khaki-core') => 'after',
                        ),
                        "std" => "before",
                        "dependency" => array(
