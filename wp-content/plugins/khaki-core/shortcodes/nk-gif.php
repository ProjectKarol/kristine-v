...
if ( ! function_exists( 'vc_nk_gif' ) ) :
    function vc_nk_gif() {
        if(function_exists('vc_map')) {
            ...
            vc_map( array(
                'name' => esc_html__('nK GIF', 'khaki-core'),
                'base' => 'nk_gif',
                'controls' => 'full',
                'category' => 'nK',
                ...
                'params' => array_merge(array(
                    array(
                        'type'       => 'attach_image',
                        'heading'    => esc_html__('Select GIF', 'khaki-core'),
                        'param_name' => 'gif',
                        'description' => '',
                        'admin_label' => true
                    ),
                    array(
                        'type'       => 'attach_image',
                        'heading'    => esc_html__('Static Image', 'khaki-core'),
                        'param_name' => 'static_image',
                        'description' => '',
                    ),
                    array(
                        'type'       => 'dropdown',
                        'heading'    => esc_html__('Play Type', 'khaki-core'),
                        'param_name' => 'type',
                        'std'        => 'default',
                        'value'      => array(
                            esc_html__('Default Autoplay', 'khaki-core')  => 'default',
                            esc_html__('Mouse Over Play', 'khaki-core')  => 'mouse-over',
                            esc_html__('On Click Play', 'khaki-core')  => 'click',
                            esc_html__('In Viewport Play', 'khaki-core')  => 'in-viewport'
                        ),
                        'description' => ''
                    ),
                    array(
