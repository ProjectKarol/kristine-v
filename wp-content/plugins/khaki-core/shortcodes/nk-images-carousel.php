...
if ( ! function_exists( 'vc_nk_images_carousel' ) ) :
    function vc_nk_images_carousel() {
        if(function_exists('vc_map')) {
            ...
            vc_map( array(
                'name' => esc_html__('nK Images Carousel', 'khaki-core'),
                ...
                'params' => array_merge(array(
                    ...
                    array(
                        'type'       => 'dropdown',
                        'heading'    => esc_html__('Images Size', 'khaki-core'),
                    ...
                    array(
                        'type'       => 'dropdown',
                        'heading'    => esc_html__('On Click', 'khaki-core'),
                        'param_name' => 'on_click',
                        'std'        => 'popup',
                        'value'      => array(
                            esc_html__('Disable', 'khaki-core') => false,
                            esc_html__('Popup', 'khaki-core') => 'popup',
                            esc_html__('Custom Link', 'khaki-core') => 'custom'
                        ),
                        'description' => esc_html__('Custom Link option works only with Link property in Media Uploader', 'khaki-core'),
                    ),
                    array(
                        'type'        => 'textfield',
