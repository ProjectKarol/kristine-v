                        ...
                        <div class="<?php echo khaki_sanitize_class($content_class);?>">
                            <div class="nk-post-meta nk-post-meta-top pb-0">
                                <div class="nk-post-date nk-post-meta-right">
                                    <?php $time_string = get_the_time(esc_html__('F j, Y ', 'khaki-core'));
                                    echo $time_string; ?>
                                    <span class="nk-post-by"><?php esc_html_e('by', 'khaki-core'); ?>
                            ...
                            <div class="nk-post-continue text-left">
                                <a href="<?php echo esc_url(get_permalink()) ?>" class="link-effect-4">
                                    <?php esc_html_e('Continue Reading', 'khaki-core'); ?>
...
if (!function_exists('vc_nk_posts_list')) :
    function vc_nk_posts_list()
    {
        ...
        if (function_exists('vc_map')) {
            ...
            vc_map(array(
                'name' => esc_html__('nK Posts List', 'khaki-core'),
                'base' => 'nk_posts_list',
                'controls' => 'full',
                'category' => 'nK',
                ...
                'params' => array_merge(array(
                    ...
                    array(
                        ...
                        "param_name" => "style",
                        "value" => array(
                            esc_html__("Classic", 'khaki-core') => "classic",
                    ...
                    array(
                        ...
                        'heading'     => esc_html__('Simple View', 'khaki-core'),
                        'type'        => 'checkbox',
                        'value'       => array( '' => true ),
                        'dependency' => array(
                            'element' => 'style',
                    ...
                    array(
                        'type'       => 'dropdown',
                        'heading'    => esc_html__('Title Looks Like', 'khaki-core'),
                    ...
                    array(
                        "type" => "textfield",
                        "heading" => esc_html__("Spacing Between News", 'khaki-core'),
                        "param_name" => "spacing_between_news",
                        "value" => 65,
                        "description" => esc_html__("Add margin bottom for all news elements", 'khaki-core'),
                    ),
                    array(
                        "type" => "textfield",
