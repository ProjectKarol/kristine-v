...
if (!function_exists('vc_nk_playlist')) :
    function vc_nk_playlist()
    {
        ...
        if (function_exists('vc_map')) {
            ...
            vc_map(array(
                'name' => esc_html__('nK Playlist', 'khaki-core'),
                'base' => 'nk_playlist',
                'controls' => 'full',
                'category' => 'nK',
                'icon' => 'icon-nk',
                'params' => array_merge(array(
                    array(
                        'type' => 'dropdown',
                        'heading' => esc_html__('Add Method', 'khaki-core'),
                        'param_name' => 'method',
                        'std' => 'playlist',
                        'value' => array(
                            esc_html__('Playlist', 'khaki-core') => 'playlist',
                            esc_html__('Audio Files', 'khaki-core') => 'files',
                        ),
                        'description' => esc_html__('select the add method', 'khaki-core')
                    ),
                    array(
                        'type' => 'dropdown',
                        'heading' => esc_html__('Select Playlist', 'khaki-core'),
                        'param_name' => 'post_id',
                        'value' => $post_list,
                        'dependency' => array(
                            'element' => 'method',
                    ...
                    array(
                        'type' => 'param_group',
                        'heading' => esc_html__('Audio Files', 'khaki-core'),
                        'value' => '',
                        'param_name' => 'tracks',
                        'params' => array(
                            array(
                                ...
                                "param_name" => "audio",
                                "heading" => esc_html__("Add Audio File", 'khaki-core'),
                                "edit_field_class" => "vc_col-sm-4",
                            ),
                            array(
                                'type' => 'textfield',
                                'heading' => esc_html__('Buy Link', 'khaki-core'),
                                'param_name' => 'buy_link',
                                'value' => '',
                            ),
                            array(
                                'type' => 'checkbox',
                                'heading' => esc_html__('Allow Download', 'khaki-core'),
                                'param_name' => 'download',
                                'value' => array('' => true)
                            ),
                    ...
                    array(
                        'type' => 'checkbox',
                        'heading' => esc_html__('Dark Style', 'khaki-core'),
