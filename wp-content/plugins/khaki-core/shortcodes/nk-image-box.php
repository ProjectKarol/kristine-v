...
if ( ! function_exists( 'vc_nk_image_box' ) ) :
    function vc_nk_image_box() {
        if(function_exists('vc_map')) {
            ...
            vc_map( array(
                'name' => esc_html__('nK Image Box', 'khaki-core'),
                'base' => 'nk_image_box',
                'controls' => 'full',
                'category' => 'nK',
                ...
                'params' => array_merge(array(
                    array(
                        'type' => 'attach_image',
                        'heading' => esc_html__("Select Image", 'khaki-core'),
                        'param_name' => 'image',
                    ),
                    array(
                        'type'       => 'dropdown',
                        'heading'    => esc_html__('Image Size', 'khaki-core'),
                    ...
                    array(
                        'param_name'  => 'box_line',
                        'heading'     => esc_html__('Box Line', 'khaki-core'),
                        'type'        => 'checkbox',
                        'value'       => array( '' => true ),
                    ),
                    array(
