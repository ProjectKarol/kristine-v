...
if ( ! function_exists( 'vc_nk_team_member' ) ) :
    function vc_nk_team_member() {
        if(function_exists('vc_map')) {
            ...
            vc_map( array(
                'name' => esc_html__('nK Team Member', 'khaki-core'),
                'base' => 'nk_team_member',
                'controls' => 'full',
                'category' => 'nK',
                ...
                'params' => array_merge(array(
                    array(
                        'type'        => 'attach_image',
                        'heading'     => esc_html__("Select Photo", 'khaki-core'),
                        'param_name'  => 'photo',
                        'admin_label' => true,
                    ),
                    array(
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Name', 'khaki-core'),
                        'param_name'  => 'title',
                        'value'       => '',
                    ),
                    array(
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Rank', 'khaki-core'),
                        'param_name'  => 'rank',
                        'value'       => '',
                    ),
                    array(
                        'type'       => 'dropdown',
                        'heading'    => esc_html__('Info Side', 'khaki-core'),
                    ...
                    array(
                        'type'       => 'dropdown',
                        'heading'    => esc_html__('Info Vertical Align', 'khaki-core'),
