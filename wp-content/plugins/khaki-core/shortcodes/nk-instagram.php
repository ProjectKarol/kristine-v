...
if ( ! function_exists( 'vc_nk_instagram' ) ) :
    function vc_nk_instagram() {
        if(function_exists('vc_map')) {
            ...
            vc_map( array(
                'name' => esc_html__('nK Instagram', 'khaki-core'),
                'base' => 'nk_instagram',
                'controls' => 'full',
                'category' => 'nK',
                ...
                'params' => array_merge(array(
                    array(
                        ...
                        'description' => esc_html__("Before use, you need to configure access to Instagram here - ", 'khaki-core') . '<a target="_blank" href="' . esc_url(admin_url('customize.php?autofocus[section]=khaki_instagram')) . '">' . esc_html(admin_url('customize.php?autofocus[section]=khaki_instagram')) . '</a>',
                    ),
                    array(
                        'type'        => 'textfield',
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Column Size', 'khaki-core'),
                    ...
                    array(
                        'type'       => 'dropdown',
                        'heading'    => esc_html__('Photo Quality', 'khaki-core'),
                        'param_name' => 'photo_quality',
                        'std'        => 'thumbnail',
                        'value'      => array(
                            esc_html__('Thumbnail', 'khaki-core')  => 'thumbnail',
                            esc_html__('Low', 'khaki-core')  => 'low_resolution',
                            esc_html__('Standard', 'khaki-core')  => 'standard_resolution'
                        ),
                        'description' => ''
                    ),
                    array(
