        ...
        while ($portfolio_query->have_posts()) : $portfolio_query->the_post();
            ...
            if (!empty($attachment) && is_array($attachment)) {
                ...
                if(isset($no_image) && !empty($no_image)){
                    ...
                    if(!empty($attachment) && is_array($attachment)){
                        $current_post_shortcode .= ' attachment_src="'. esc_url($attachment['src']). '" attachment_alt="'.esc_attr__('No Image', 'khaki-core').'"';
                    }
                } else{
                    $current_post_shortcode .= ' attachment_src="' . esc_url(get_template_directory_uri() . '/assets/images/no-image.jpg') . '" attachment_alt="'.esc_attr__('No Image', 'khaki-core').'"';
                }
            }
...
if ( ! function_exists( 'vc_nk_portfolio_custom_list' ) ) :
    function vc_nk_portfolio_custom_list() {
        if(function_exists("vc_map")) {
            ...
            vc_map( array(
                "name"     => esc_html__("nK Portfolio Custom List", 'khaki-core'),
                ...
                "params"   => array_merge(array(
                    ...
                    array(
                        'param_name'  => 'gap',
                        'heading'     => esc_html__('Gap', 'khaki-core'),
                        'type'        => 'checkbox',
                        'value'       => array( '' => true ),
                    ),
                    array(
...
if ( ! function_exists( 'vc_nk_portfolio_item' ) ) :
    function vc_nk_portfolio_item() {
        if(function_exists("vc_map")) {
            /* Register shortcode with Visual Composer */
            vc_map( array(
                "name"     => esc_html__("nK Portfolio Item", 'khaki-core'),
                ...
                "params"   => array_merge(array(
                    array(
                        "type"        => "textfield",
                        "heading"     => esc_html__("ID", 'khaki-core'),
                        "param_name"  => "id",
                        "value"       => "",
                        "description" => "",
                    ),
                    array(
                        ...
                        'std'        => 'md',
                        'value'      => array(
                            esc_html__('Square', 'khaki-core')  => 'square',
                            esc_html__('Big Square', 'khaki-core')  => 'big-square',
                            esc_html__('Horizontal Rectangle', 'khaki-core')    => 'horizontal-rectangle',
                            esc_html__('Vertical Rectangle', 'khaki-core')  => 'vertical-rectangle',
                        ),
                        'description' => ''
                    ),
                    array(
                    ...
                    array(
                        ...
                        'heading'     => esc_html__('Hide Title', 'khaki-core'),
                        'type'        => 'checkbox',
                        'value'       => array( '' => true ),
                    ),
                    array(
                        'param_name'  => 'hide_date',
                        'heading'     => esc_html__('Hide Date', 'khaki-core'),
                        'type'        => 'checkbox',
                        'value'       => array( '' => true ),
                    ),
                    //isotope
...
if ( ! function_exists( 'vc_nk_portfolio_custom_item' ) ) :
    function vc_nk_portfolio_custom_item() {
        if(function_exists("vc_map")) {
            /* Register shortcode with Visual Composer */
            vc_map( array(
                "name"     => esc_html__("nK Portfolio Custom Item", 'khaki-core'),
                ...
                "params"   => array_merge(array(
                    array(
                        'type'       => 'attach_image',
                        'heading'    => esc_html__('Background Image', 'khaki-core'),
                        'param_name' => 'image',
                        'description' => ''
                    ),
                    array(
                        "type"        => "textfield",
                        "heading"     => esc_html__("Matching Filter", 'khaki-core'),
                        "param_name"  => "data_filter",
                        "value"       => "",
                        "description" => esc_html__("Used only if set Filter option for parent nK Portfolio List", 'khaki-core'),
                    ),
                    array(
                        'type'       => 'dropdown',
                        'heading'    => esc_html__('Size', 'khaki-core'),
