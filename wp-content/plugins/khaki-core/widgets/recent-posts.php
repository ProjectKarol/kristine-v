...
class NK_Recent_Posts extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            esc_html__('(nK) Recent Posts', 'khaki-core'), // Name
    ...
    {
        $title = !empty($instance['title']) ? $instance['title'] : esc_html__('Recent Posts', 'khaki-core');
        ...
        <p>
            <label
                for="<?php echo esc_attr($this->get_field_id('posts_count')); ?>"><?php esc_html_e('Posts Count:', 'khaki-core'); ?></label>
        ...
        <p>
            ...
            <label
                for="<?php echo esc_attr($this->get_field_id('show_date')); ?>"><?php esc_html_e('Show Date', 'khaki-core'); ?></label>
        </p>
        <?php
    }
...
add_action('widgets_init', 'register_nk_recent_post_widget');

if ( ! function_exists('register_nk_recent_post_widget') ):
    function register_nk_recent_post_widget() {
        register_widget( 'NK_Recent_Posts' );
    }
endif;