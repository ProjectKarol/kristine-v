...
class NK_Custom_Image extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            esc_html__('(nK) Custom Image', 'khaki-core'), // Name
...
add_action('widgets_init', 'register_nk_custom_image_widget');

if ( ! function_exists('register_nk_custom_image_widget') ):
    function register_nk_custom_image_widget() {
        register_widget( 'NK_Custom_Image' );
    }
endif;
